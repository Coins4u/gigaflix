...
export const metadata: Metadata = {
  title: "Senderkategorien | GiGa FliX IPTV",
  description:
    "Entdecken Sie GiGa FliX Senderkategorien: Sport, Filme, News, Kids, Entertainment und Musik in HD und 4K.",
  alternates: { canonical: "https://gigaflixiptv.com/de/channels" },
};
...
export default function DeChannelsPage() {
  return (
    <>
        ...
        <div className="container">
          <div className="nav-wrapper">
            ...
            <nav className="nav-links">
              ...
              <Link href="/de/channels" className="nav-link active">
                Sender
              </Link>
      ...
      <main className="channel-categories-page" role="main">
        <div className="container">
          <h1 className="channel-categories-hero__title">Unsere Senderkategorien</h1>
          <p className="channel-categories-hero__lead">
            Ein kurzer Überblick über die Inhalte der GiGa FliX Pakete. Die genaue Anzahl an
            Sendern variiert je nach Plan und Server — die aktuellen Details finden Sie bei den
            Preisen.
          </p>
        </div>

        <ol className="channel-timeline" aria-label="Liste der Senderkategorien">
        ...
        <div className="container">
          <div className="channel-categories-cta">
            <Link href="/de#pricing" className="btn btn-primary">
              Pakete ansehen
            </Link>
            <Link href="/de/contact" className="btn btn-outline">
          ...
          <div className="footer-content">
            ...
            <div className="footer-links">
              ...
              <ul>
                ...
                <li>
                  <Link href="/de/channels">Sender</Link>
                </li>
                <li>
